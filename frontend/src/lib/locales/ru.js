...
export default {
  ...
  'notes.toTrash': 'В корзину',
  'notes.folderActions': 'Действия с папкой',
  ...
  'confirm.lastMessage': 'Последнее сообщение',
  'confirm.request': 'Заявка',
  'confirm.noRequest': 'Пока нет',
  ...
  'appointments.colorAuto': 'Автоматически',
  'color.indigo': 'Индиго',
  ...
  'thread.ai.leading': 'Ассистент ведёт разговор',
  'thread.ai.takeOver': 'Ответить самому',
  'thread.ai.youReply': 'Вы отвечаете сами',
  'thread.ai.handBack': 'Вернуть ассистенту',
  'thread.ai.replying': 'Отвечает',
  'thread.ai.waiting': 'Ждёт ответа клиента',
  ...
  'inbox.archive': 'Архив',
  'inbox.archiveEmpty': 'В архиве пусто',
  'inbox.trash': 'Корзина',
  'inbox.trashEmpty': 'Корзина пуста',
  'inbox.toArchive': 'В архив',
  'inbox.fromArchive': 'Вернуть из архива',
  'inbox.delete': 'Удалить',
  'inbox.restore': 'Восстановить',
  'inbox.deleteForever': 'Удалить навсегда',
  'inbox.deleteForeverTitle': 'Удалить переписку навсегда?',
  'inbox.deleteForeverText': 'Сообщения и фото будут стёрты. Вернуть их будет нельзя.',
  'inbox.binNotice': 'Разговоры в корзине хранятся {days} дней, а затем удаляются навсегда — вместе с сообщениями и фото.',
  'inbox.purgeColumn': 'Удалится через',
  'inbox.purgeIn': '{days} дн.',
  'inbox.purgeToday': 'Сегодня',
  'inbox.search': 'Поиск',
  'inbox.filter': 'Фильтр',
