...
export default {
  ...
  'home.card.on': 'Работает',
  'home.card.deaf': 'Сообщения не доходят',
  'home.card.off': 'Telegram не подключён',
  'home.card.live': 'Активные чаты',
  'home.card.human': 'Отвечаете вы',
  'home.card.unread': 'Непрочитанные',
  'home.card.today': 'Записи сегодня',
