...
export default {
  ...
  'notes.toTrash': 'Move to trash',
  'notes.folderActions': 'Folder actions',
  ...
  'confirm.lastMessage': 'Last message',
  'confirm.request': 'Request',
  'confirm.noRequest': 'None yet',
  ...
  'appointments.colorAuto': 'Automatic',
  'color.indigo': 'Indigo',
  'color.violet': 'Violet',
  ...
  'thread.ai.leading': 'The assistant is handling this chat',
  'thread.ai.takeOver': 'Reply yourself',
  'thread.ai.youReply': 'You are replying',
  'thread.ai.handBack': 'Hand back to the assistant',
  'thread.ai.replying': 'Replying',
  'thread.ai.waiting': 'Waiting for the client',
  ...
  'assistant.landmark': 'Landmark',
  'assistant.languages': 'Languages',
  'assistant.payment': 'Payment methods',
  'assistant.pick': 'Choose',
  'assistant.services': 'Services',
  'assistant.serviceAdd': 'Add',
  'assistant.edit': 'Edit',
  'assistant.serviceRemove': 'Remove service',
  'assistant.editDone': 'Done',
  'assistant.serviceName': 'Service name',
  'assistant.servicesEmpty': 'No services yet. The assistant has nothing to offer while this list is empty.',
  'assistant.hours': 'Working hours',
  'assistant.dayOff': 'Closed',
  ...
  'inbox.archiveEmpty': 'The archive is empty',
  'inbox.trash': 'Bin',
  'inbox.trashEmpty': 'The bin is empty',
  'inbox.toArchive': 'Archive',
  'inbox.fromArchive': 'Move out of the archive',
  'inbox.delete': 'Delete',
  'inbox.restore': 'Restore',
  'inbox.deleteForever': 'Delete forever',
  'inbox.deleteForeverTitle': 'Delete this conversation forever?',
  'inbox.deleteForeverText': 'Its messages and photos will be erased. This can’t be undone.',
  'inbox.binNotice': 'Conversations in the bin are kept for {days} days, then deleted forever along with their messages and photos.',
  'inbox.purgeColumn': 'Deleted in',
  'inbox.purgeIn': '{days} d',
  'inbox.purgeToday': 'Today',
  'inbox.search': 'Search',
  'inbox.filter': 'Filter',
