    ...
    <>
      ...
      <div className={styles.page} aria-label="Страница записей">
        {/* Same padding as `/business`, and no max-width: the calendar below
            ...
            One inset on three sides — 16px above and to either edge, matching
            each other so the card sits in a frame rather than in a margin that
            is a different width in every direction. Only the bottom is left
            wider, since it is the end of the page rather than a seam. */}
