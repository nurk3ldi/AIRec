...
export default function InboxPage() {
  ...
  return (
    ...
    >
      {/* **Доли, а не проценты.** `flex-[75]` и `flex-[25]` делят то, что
          осталось, поэтому 75/25 держится при любом зазоре и любой рамке, а
          `w-[75%]` и `w-[25%]` вместе с ними дали бы больше ста и уронили бы
      ...
      <div className="min-w-0 flex-[75] overflow-y-auto p-4 sm:p-6">
      ...
      <aside className="hidden min-w-0 flex-[25] flex-col p-4 lg:flex">
