 ...
 *
 * **`bg-ink/6`, а не белый литерал.** Просили «чтобы загоралась белым», и на
 ...
 * обеих. Та же величина, которой подсвечиваются дни в календаре.
 *
...
function Td({ className = '', children }) {
  return (
    <td
      className={`truncate py-3 pr-4 transition-colors duration-150 ease-out group-hover:bg-ink/6 first:rounded-l-lg first:pl-1 last:rounded-r-lg last:pr-1 ${className}`}
    >
      {children}
    </td>
  )
