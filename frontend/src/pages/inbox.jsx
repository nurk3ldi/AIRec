 ...
 * занимает колонку целиком и берёт в себя убранные разговоры. Нажатое — тем же
 * словом, но полужирным: цвет здесь уже занят (всё белое), и вес — то, что
 * остаётся сказать состояние.
 *
