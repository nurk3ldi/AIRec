        ...
        <div className="flex flex-col items-center pt-1 pb-8">
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-0 bottom-0 grid h-7 w-7 place-items-center rounded-full border-2 border-ground bg-ink text-surface after:absolute after:-inset-2 after:content-[''] transition-transform duration-150 ease-out active:scale-[0.95]"
            >
              <HugeiconsIcon
